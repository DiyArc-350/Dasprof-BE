...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login | Admin Daskom Profile</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="row">
                                    <div class="col-7">
                                        <div class="text-dark p-4">
                                            <h5 class="text-dark">Welcome Min!!</h5>
                                            <p>Sign in to amuze them</p>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0"> 
                                    ...
                                    <a class="auth-logo-light">
                                        <div class="avatar-md profile-user-wid mb-4">
                                            <span class="avatar-title rounded-circle bg-light">
                                                <img src="{{ asset('/assets/admin/images/logo/daskom_logo.png') }}" alt="" class="rounded-circle" height="57">
                                            </span>
                                        </div>
                                    </a>
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" method="post" action="{{ route('user.login') }}">
                                        {{ csrf_field() }}
                                        <div class="mb-3">
                                            <label for="ascod" class="form-label">Assistant Code</label>
                                            <input type="text" class="form-control" id="ascod"   placeholder="DII" name="ascod" autofocus required>
                                        </div>
                        ...
                        <div class="mt-5 text-center text-white">
                            ...
                            <div>
                                <p>© <script>document.write(new Date().getFullYear())</script> Mixue Matcha</p>
                            </div>
                        </div>
